...
type Props = RouteComponentProps & CardPaymentProps;

const CardPayment: React.FunctionComponent<Props> = (props: Props) => {
  ...
  return (
    <>
      ...
      <section className="section section-cardPayment">
        <h2 className="payment-block__title">Visa/Mastercard payment</h2>
        ...
        <div className="bank">
          <div id="cards">
            ...
            <div id="back">
              ...
              <label id="code-label" className="label">Safety code</label>
            </div>
          </div>
        </div>
